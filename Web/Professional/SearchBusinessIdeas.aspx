<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true"
    CodeBehind="SearchBusinessIdeas.aspx.cs" Inherits="Web.Professional.SearchBusinessIdeas" %>
    ...
    <asp:MultiView ID="mvProjects" runat="server" ActiveViewIndex="0">
        <asp:View ID="vList" runat="server">
            <table width="100%">
                <tr>
                    <td class="Baslik">
                        <asp:Literal ID="ltSearchForBusinessideas" runat="server"></asp:Literal>
                    </td>
                </tr>
            </table>
            <table class="belgeHeader" width="100%">
                <tr>
                    <td class="inputs">
                        <asp:GridView ID="gvListe" runat="server" AutoGenerateColumns="False" DataKeyNames="RECID,CREATEDBY"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="INVESTMENTAMOUNT" HeaderText="investmentAmount" DataFormatString="{0:N0}"
                                    HtmlEncode="false" />
                                <asp:BoundField HeaderText="EntrepreneurName" />
                                <asp:BoundField HeaderText="isCertified" DataField="APPROVED" />
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <%--
                                        <table class="belgeHeader" width="100%">
                                            <tr>
                                               <td id="tdPPT" runat="server" class="inputs">
                                                ...
                                                <td class="inputs">
                                                    <asp:ImageButton ID="ibDanismanlar" runat="server" CausesValidation="false" CommandName="memberDetail"
                                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"CREATEDBY") %>' ImageUrl="~/images/professional.png" />
                                                </td>
                                                <td class="inputs">--%>
                ...
                <tr>
                    <td class="inputs">
                        <asp:Button ID="btnAra" runat="server" CssClass="btnListele" />
                                ...
                                <tr>
                                    <td valign="top" class="PencereBaslik">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td align="left">
                                                    <asp:Literal ID="ltEnterSearchFilter" runat="server"></asp:Literal>
                                                </td>
                                                <td align="right">
                                    ...
                                    <td class="PencereDetay">
                                        <table class="belgeHeader" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="inputs">
                                                    <asp:TextBox ID="txtAmount1" runat="server" ValidationGroup="search"></asp:TextBox>
                                                    &nbsp;<asp:CompareValidator ID="excvtxtAmount1" runat="server" ControlToValidate="txtAmount1"
                                                        Display="Dynamic" ErrorMessage="invalidCurrency" Operator="DataTypeCheck" SetFocusOnError="True"
                                                        Type="Integer" ValidationGroup="search">!</asp:CompareValidator>
                                                    &nbsp;-&nbsp;
                                                    <asp:TextBox ID="txtAmount2" runat="server" ValidationGroup="search"></asp:TextBox>
                                                    &nbsp;<asp:CompareValidator ID="excvtxtAmount2" runat="server" ControlToValidate="txtAmount2"
                                                        Display="Dynamic" ErrorMessage="invalidCurrency" Operator="DataTypeCheck" SetFocusOnError="True"
                                                        Type="Integer" ValidationGroup="search">!</asp:CompareValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="inputs">
                                                    <asp:CheckBox ID="cbisCertifiedByAdmin" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="labels">
                                                ...
                                                <td class="inputs">
                                                    <asp:Button ID="btnFiltrele" runat="server" CssClass="btnListele" OnClick="btnFiltrele_Click"
                                                        ValidationGroup="search" />
                                                    <asp:ValidationSummary ID="vdsum" runat="server" ShowMessageBox="True" ShowSummary="False"
                                                        ValidationGroup="search" />
                                                </td>
                                            </tr>
                                        </table>
        ...
        <asp:View ID="vProjectDetail" runat="server">
            ...
            <table class="belgeHeader" width="100%">
                ...
                <tr>
                    <td class="labels">
                        <asp:Literal ID="lbSector" runat="server"></asp:Literal>
                    </td>
                    <td class="inputs">
                ...
                <tr>
                    ...
                    <td class="inputs">
                        <asp:Button ID="btnProjeyeDanismanOl" runat="server" CssClass="btnKritik" OnClick="btnProjeyeDanismanOl_Click" />
