<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true"
    CodeBehind="MyInvestments.aspx.cs" Inherits="Web.Investor.MyInvestments" %>
    ...
    <asp:MultiView ID="mvProjects" runat="server" ActiveViewIndex="0">
        <asp:View ID="vList" runat="server">
            <table width="100%">
                <tr>
                    <td class="Baslik">
                        <asp:Literal ID="ltMyInvestments" runat="server"></asp:Literal>
                    </td>
                </tr>
            </table>
            <table class="belgeHeader" width="100%">
                <tr>
                    <td class="inputs">
                        <asp:GridView ID="gvListe" runat="server" AutoGenerateColumns="False" DataKeyNames="RECID,ENTREAPPROVED"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ENTREPRENEUR">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="exlbEntrepreneur" CssClass="tip" Text='<%#DataBinder.Eval(Container.DataItem,"NAMESURNAME") %>'
                                            runat="server" CausesValidation="false" CommandName="Entrepreneur" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ENTREPRENEUR") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="MODIFICATIONDATE" HeaderText="MODIFICATIONDATE" HtmlEncode="false"
                                    DataFormatString="{0:dd.MM.yyyy}" />
                                <asp:CheckBoxField HeaderText="ENTREPRENEURAPPROVED" DataField="ENTREAPPROVED" />
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <table class="belgeHeader" width="100%">
                                            <tr>
                                                ...
                                                <td class="inputs">
                                                    <asp:ImageButton ID="ibSec" runat="server" CausesValidation="false" CommandName="viewProject"
