<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true"
    CodeBehind="SearchBusinessIdeas.aspx.cs" Inherits="Web.Investor.SearchBusinessIdeas" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <table class="belgeHeader" width="100%">
                                            <tr>
                                                <td style="display: none" id="tdPPT" runat="server" class="inputs">
                                                ...
                                                <td style="display: none" class="inputs">
        ...
        <asp:View ID="vProjectDetail" runat="server">
            ...
            <table class="belgeHeader" width="100%">
                ...
                <tr>
                    ...
                    <td class="inputs">
                        <asp:Button ID="btnAddToMyInvestments" runat="server" CssClass="btnKritik" OnClick="btnProjeyeDanismanOl_Click" />
