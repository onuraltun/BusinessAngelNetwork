<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="True"
    CodeBehind="MyAdvisor.aspx.cs" Inherits="Web.Common.MyAdvisor" %>

<%@ Register Src="../ASCX/WriteMessage.ascx" TagName="WriteMessage" TagPrefix="uc10" %>
<%@ Register Src="../ASCX/AddProfessionalFeedback.ascx" TagName="AddProfessionalFeedback"
    TagPrefix="uc1" %>
<asp:Content ID="Content4" ContentPlaceHolderID="ctphMiddle" runat="server">
    <asp:GridView ID="gvProject" runat="server" AutoGenerateColumns="False" OnRowCommand="gvProject_RowCommand"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="PROJECTPROFESSIONALS">
                <ItemTemplate>
                    <table class="belgeHeader" width="100%">
                        <tr>
                            <td class="inputs">
                                <asp:ImageButton ID="ibView" runat="server" CausesValidation="false" CommandName="ListPro"
                                    CssClass="tip" ToolTip="PROJECTPROFESSIONALS" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"RECID") %>'
    ...
    <asp:GridView ID="gvListe" OnRowDataBound="gvListe_RowDataBound" runat="server" OnRowCommand="gvListe_RowCommand"
        AutoGenerateColumns="False" DataKeyNames="RECID,APPROVED">
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <table class="belgeHeader" width="100%">
                        <tr>
                            <td class="inputs">
                                <asp:ImageButton ID="ibViewMember" runat="server" CausesValidation="false" CommandName="View"
                                    CssClass="tip" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"RECID") %>'
                                    ImageUrl="~/images/ara.gif" />
                            </td>
                            <td class="inputs">
                                <asp:ImageButton ID="ibView" runat="server" CausesValidation="false" CommandName="Message"
                                    CssClass="tip" ToolTip="Send Message" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"RECID") %>'
                                    ImageUrl="~/images/mail.png" />
                            </td>
                            <td class="inputs">
                                <asp:ImageButton ID="ibFeedback" runat="server" CausesValidation="false" CommandName="Feedback"
                                    CssClass="tip" ToolTip="Feedbacks" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"RECID") %>'
                                    ImageUrl="~/images/FilledStar.png" />
                            </td>
                            <td id="tdAccept" runat="server" visible="false" class="inputs">
                                <asp:ImageButton ID="ibDanismanlar" runat="server" CausesValidation="false" CommandName="AddPro"
                                    CssClass="tip" ToolTip="Accept Professional" OnRowCommand="gvListe_RowCommand"
                            ...
                            <td id="tdRemoveAccept" runat="server" visible="false" class="inputs">
                                <asp:ImageButton ID="ibRemoveAccept" runat="server" CausesValidation="false" CommandName="RemoveAccept"
                                    CssClass="tip" ToolTip="Remove Accept" OnRowCommand="gvListe_RowCommand" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"RECID") %>'
    ...
    <uc1:AddProfessionalFeedback ID="AddProfessionalFeedback1" Visible="false" runat="server" />
