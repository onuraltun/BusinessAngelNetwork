<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="True"
    CodeBehind="Default.aspx.cs" Inherits="Web.Entrepreneur.Default" %>
...
<%@ Register Src="../ASCX/AddEventToForum.ascx" TagName="AddEventToForum" TagPrefix="uc12" %>
<asp:Content ID="Content3" ContentPlaceHolderID="ctphLeft" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlMemberLeft">
        ...
        <br />
        <uc12:AddEventToForum runat="server" ID="AddEventToForum1" />
    </asp:Panel>
    <br />
